    ...
    <div class="hero">
      ...
      <p>
        <template v-if="isWelcome">
          进来坐坐。想先花两三分钟画一张职场小像也可以；不想测的话，随时可以去别处看看。
        </template>
        <template v-else>
          约 12 题、两三分钟。趣味职场风格速写，不是诊断，也不影响录用。
        </template>
      </p>
    </div>
...
const QUESTIONS = [
  ...
  { n: 2, key: 'q2', text: '只要现有流程还能用，我更想少改结构、少碰不确定的方案。' },
  { n: 3, key: 'q3', text: '重要交付前，我会把里程碑和风险点提前排清楚，而不是临场抱佛脚。' },
  { n: 4, key: 'q4', text: '答应别人的事，我通常会跟到底，很少不了了之。' },
  { n: 5, key: 'q5', text: '计划经常变，我更习惯走到哪想到哪，细则以后再说。' },
  { n: 6, key: 'q6', text: '跨部门对齐或客户会，我往往愿意先开口带动气氛、把议题推起来。' },
  { n: 7, key: 'q7', text: '连续社交或开会后，我更需要独自待一会儿才能缓过来。' },
  { n: 8, key: 'q8', text: '意见不合时，我更想先找都能接受的点，而不是先争对错。' },
  { n: 9, key: 'q9', text: '为了把事情做成，我可以比较直接地指出问题，哪怕场面一时尴尬。' },
  { n: 10, key: 'q10', text: '被挑战或挂面后，我脑子里容易反复回放，短时间难抽离。' },
  { n: 11, key: 'q11', text: '临近述职、谈薪或关键评审，我的紧张感会明显抬头。' },
  { n: 12, key: 'q12', text: '压力来了，我大多能较快稳住情绪，继续把下一步做掉。' },
]
